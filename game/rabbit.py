...
class RabbitGameAI:
    ...
    def __init__(self, w=30 * BLOCK_SIZE, h=20 * BLOCK_SIZE, game_speed = 1000, game_level = 1, wall_density=10):
        self.w = w
        self.h = h
    ...
    def _generate_maze(self):
        ...
        # add wall points
        for _ in range(self.wall_density):
                x = random.randint(1, (self.w // BLOCK_SIZE) - 2)
                y = random.randint(1, (self.h // BLOCK_SIZE) - 2)
                maze[y][x] = 1
    ...
    #     # Simple inner walls (example: vertical and horizontal lines)
    #     for x in range(5, (self.w // BLOCK_SIZE) - 5):
    #         if x % 4 == 0:
    #             maze[7][x] = 1
    #             maze[12][x] = 1
        
    #     for y in range(5, (self.h // BLOCK_SIZE) - 5):
    #         if y % 4 == 0:
    #             maze[y][9] = 1
    #             maze[y][15] = 1
...
#         pygame.display.set_caption('Rabbit Game')
#         self.clock = pygame.time.Clock()
#         # self.wall_density = 0  # Start with a few walls
#         self.reset()
...
#     def _generate_maze(self, level_up=False):
#         maze = [[0 for _ in range(self.w // BLOCK_SIZE)] for _ in range(self.h // BLOCK_SIZE)]
...
#         if level_up:
#             # Add more walls as difficulty increases
#             for _ in range(self.wall_density):
#                 x = random.randint(1, (self.w // BLOCK_SIZE) - 2)
#                 y = random.randint(1, (self.h // BLOCK_SIZE) - 2)
#                 maze[y][x] = 1
...
#         self.wall_density += 2  # Add 5 more walls every level up
#         self.wall = self._generate_maze(level_up=True)
#         self._place_carrot()
#         if self.game_level > 2:
#             self.enemies = []
#             for _ in range(MAX_ENEMIES):
